                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="mt-4 sm:mt-5 md:mt-6 space-y-3 sm:space-y-4 text-start">
                            <p className="text-[15px] sm:text-[16px] md:text-[21px] font-neuhas text-[#30454c] leading-relaxed">
                                At SOLTECH TechServices, we believe in focused expertise. That's why we operate through specialized verticals, each dedicated to mastering their domain and delivering exceptional value to clients.
                            </p>
                            <p className="text-[15px] sm:text-[16px] md:text-[21px] font-neuhas text-[#30454c] leading-relaxed">
                                Our verticals work both independently and collaboratively, offering clients the flexibility to engage with specific expertise or leverage our full ecosystem for comprehensive solutions.
                            </p>
                            <p className="text-[15px] sm:text-[16px] md:text-[21px] font-neuhas text-[#30454c] leading-relaxed">
                                From AI-powered business solutions to digital marketing excellence, each vertical represents our commitment to innovation, quality, and client success.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* <section className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 text-center">
                <div className="px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20">
                    ...
                    <p className="text-[16px] md:text-[20px] text-[#2d3b40]/80 leading-[30px] max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl xl:max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-10 px-4 sm:px-0 font-neuhas">
                        Connect with our team to explore how SOLTECH verticals can help your business achieve its goals through innovation and technology.
                    </p>
